...
public class gexfGenerate {

    public static void  geph4j() throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("./LPAReorganizeOutput/part-r-00000"));
        ...
        BufferedReader br_ = new BufferedReader(new FileReader("./LPAReorganizeOutput/part-r-00000"));
        while((line = br_.readLine())!= null){
            ...
            if (node == null){
                ...
                String cur_label = map.get(name);
                node.setLabel(name)
                        .getAttributeValues()
                        .addValue(attUrl, cur_label)
            ...
            for (String namePair:nameList.split(";")){
                ...
                if (name_node == null){
                    ...
                    String cur_label = map.get(name_value_pair[0]);
